...
export const wedding: WeddingConfig = {
  ...
  cover: {
    ...
    groomName: '김민구',
    brideName: '이서연',
    datetimeISO: '2026-10-17T13:00:00+09:00', // 요일/D-day 전부 여기서 파생
  ...
  greeting: {
    ...
    groom: {
      person: { name: '김민구', phone: '010-1234-5678', birthOrder: '장남' },
      father: { name: '김아버지', phone: '010-1111-1111' },
      mother: { name: '박어머니', phone: '010-2222-2222' },
    },
    bride: {
      person: { name: '이서연', phone: '010-8765-4321', birthOrder: '차녀' },
  ...
  accounts: {
    ...
    list: [
      { side: 'groom', holderLabel: '신랑 김민구', bank: '국민은행', number: '123-45-678901', kakaoPayUrl: '' },
      { side: 'groom', holderLabel: '아버지 김아버지', bank: '신한은행', number: '110-222-333444' },
      { side: 'bride', holderLabel: '신부 이서연', bank: '카카오뱅크', number: '3333-01-2345678', kakaoPayUrl: '' },
  ...
  share: {
    ...
    ogTitle: '민구 ♥ 서연 결혼합니다',
    ogDescription: '2026.10.17 (토) 오후 1시, ○○웨딩홀 3F 그랜드볼룸',
